echo "windows-x86_64/bootstrap.ps1"
...
C:\tools\msys64\usr\bin\bash.exe -l -c @"
    ...
    pacman -S --refresh --needed --noconfirm mingw-w64-x86_64-toolchain
    pacman -S --refresh --needed --noconfirm mingw-w64-x86_64-jasper
    pacman -S --refresh --needed --noconfirm mingw-w64-x86_64-qt5-static
"@
